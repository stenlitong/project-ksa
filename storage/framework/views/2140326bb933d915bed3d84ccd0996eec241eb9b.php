            ...
            <table class="table" id="myTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php if(strpos($oh -> status, 'Order') !== false): ?>
                            <td>
                        ...
                        <?php if(strpos($oh -> status, 'Approved By Purchasing') !== false): ?>
                        ...
                        <div class="modal-dialog modal-dialog-scrollable modal-lg modal-dialog-centered modal-lg" role="document">
                            <div class="modal-content">
                                    ...
                                    <table class="table">
                                        <thead class="thead-dark">
                                            <tr>
                                                ...
                                                <?php if(strpos($o -> status, 'Items Ready') !== false || strpos($o -> status, 'On Delivery') !== false || strpos($o -> status, 'Order In Progress') !== false): ?>
                                                <?php else: ?>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <?php if(strpos($o -> status, 'In Progress By Logistic') !== false): ?>
                                        
                                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#reject-order-<?php echo e($o -> id); ?>">Reject</button>
                                        <a href="/logistic/order/<?php echo e($o->id); ?>/approve" class="btn btn-primary">Approve</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
