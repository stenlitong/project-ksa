<?php if(Auth::user()->hasRole('adminLogistic')): ?>
    ...
    <?php $__env->startSection('title', 'Stocks Page'); ?>
    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <h1 class="mt-3" style="margin-left: 40%">Create Order</h1>
            <br>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="row">
                <div class="col">
                    <form method="POST" action="/admin-logistic/create-order/<?php echo e($cabang); ?>/add-cart">
                        <?php echo csrf_field(); ?>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <form method="POST" action="/admin-logistic/create-order/<?php echo e($cabang); ?>/<?php echo e($c -> id); ?>/delete-cart">
                                        <?php echo csrf_field(); ?>
        ...
        <div class="modal fade" id="submit-order" tabindex="-1" role="dialog" aria-labelledby="submit-orderTitle" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document" style="max-width: 600px;">
                <div class="modal-content">
                    ...
                    <form method="POST" action="/admin-logistic/create-order/<?php echo e($cabang); ?>/<?php echo e(Auth::user()->id); ?>/submit-order">
                        <?php echo csrf_field(); ?>
                        <div class="modal-body"> 
                            ...
                            <div class="d-flex justify-content-start mr-3">
                                <div class="form-group p-2">
                                    <div class="col">
                                        <label for="bargeName">Pilih Barge (Bisa Dikosongkan):</label>
                                    </div>
                                    <div class="col">
...
<?php endif; ?>
<?php echo $__env->make('../layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Kuliah\Magang\Project\app\app-ver1\resources\views/adminLogistic/adminLogisticCreateOrderForm.blade.php ENDPATH**/ ?>