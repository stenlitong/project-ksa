                ...
                <div class="flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 mt-3">
                    ...
                    <div class="d-flex justify-content-start mb-3">
                        ...
                        <?php if(count($orderHeads) > 0): ?>
                            <a href="<?php echo e(Route('supervisor.downloadIn')); ?>" class="btn btn-outline-danger ml-auto mr-3" target="_blank">Export</a>
                        <?php endif; ?>
                    </div>
...
<?php endif; ?>
<?php echo $__env->make('../layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Kuliah\Magang\Project\app\app-ver1\resources\views/supervisor/supervisorHistoryIn.blade.php ENDPATH**/ ?>