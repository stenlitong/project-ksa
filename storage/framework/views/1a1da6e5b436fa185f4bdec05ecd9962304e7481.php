...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="<?php echo e(Route("adminLogistic.addItem")); ?>">
                                <?php echo csrf_field(); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-between">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" id="detail" data-target="#editItem-<?php echo e($i->id); ?>">
                                        Edit Item
                                    </button>
            ...
            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="modal fade" id="editItem-<?php echo e($i->id); ?>" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="/admin-logistic/<?php echo e($i->id); ?>/edit">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="codeMasterItem"
                                            ...
                                            value="<?php echo e($i -> codeMasterItem); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="description">Deskripsi (optional)</label>
                                        <textarea class="form-control" name="description" id="description" rows="3"
...
<?php echo $__env->make('../layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Kuliah\Magang\Project\app\app-ver1\resources\views/adminLogistic/adminLogisticStocks.blade.php ENDPATH**/ ?>