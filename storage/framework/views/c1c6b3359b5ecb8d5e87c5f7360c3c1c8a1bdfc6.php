...
<?php endif; ?>
                ...
                <select name="role_id" id="role_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" required>
                    ...
                    <option value="picIncident" id="picIncident">Insurance Incident</option>
                    <option value="insurance" id="insurance">Manager Asuransi</option>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH D:\Kuliah\Magang\Project\app\app-ver1\resources\views/auth/registerAdmin.blade.php ENDPATH**/ ?>