...
class CreateDocumentJakartasTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('document_jakartas', function (Blueprint $table) {
            ...
            $table->string('pengesahan_gambar', 180)->nullable();
