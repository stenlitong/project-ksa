...
class CreateSamarindadb extends Migration
{
    ...
    public function up()
    {
        Schema::create('samarindadb', function (Blueprint $table) {
            ...
            $table->string('sertifikat_keselamatan(perpanjangan)', 170)->nullable();

            $table->dateTime('time_upload2')->nullable();
            $table->string('status2', 10)->nullable();
            $table->string('reason2', 170)->nullable();
            $table->string('perubahan_ok_13_ke_ok_1', 170)->nullable();
            ...
            $table->string('perubahan_sertifikat_keselamatan', 170)->nullable();

            $table->dateTime('time_upload14') ->nullable();
            $table->string('status14', 10)->nullable();
            $table->string('reason14', 170)->nullable();
            $table->string('perubahan_kawasan_tanpa_notadin', 170)->nullable();
