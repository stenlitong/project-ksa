                ...
                <div class="d-flex justify-content-between mr-3">
                    <div class="p-2">
                        <select name="cabang" class="form-select" onchange="window.location = this.value;">
                            ...
                            <option value="/purchasing/report-ap/Jakarta" 
                                @php
                                ...
                                @endphp
                            >Jakarta</option>
                            <option value="/purchasing/report-ap/Banjarmasin"
                                @php
                                ...
                                @endphp
                            >Banjarmasin</option>
                            <option value="/purchasing/report-ap/Samarinda"
                                @php
                                ...
                                @endphp
                            >Samarinda</option>
                            <option value="/purchasing/report-ap/Bunati"
                                @php
                                ...
                                @endphp
                            >Bunati</option>
                            <option value="/purchasing/report-ap/Babelan"
                                @php
                                ...
                                @endphp
                            >Babelan</option>
                            <option value="/purchasing/report-ap/Berau"
                                @php
