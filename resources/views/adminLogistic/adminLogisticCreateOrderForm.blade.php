@if(Auth::user()->hasRole('adminLogistic'))
    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="row">
                <div class="col">
                    <form method="POST" action="/admin-logistic/create-order/{{ $cabang }}/add-cart">
                        @csrf
                        ...
                        <tbody>
                            @foreach($carts as $c)
                                <tr>
                                    ...
                                    <td>{{ $c -> note }}</td>
                                    {{-- Delete Item --}}
                                    <form method="POST" action="/admin-logistic/create-order/{{ $cabang }}/{{ $c -> id }}/delete-cart">
                                        @csrf
                                        @method('delete')
        ...
        <div class="modal fade" id="submit-order" tabindex="-1" role="dialog" aria-labelledby="submit-orderTitle" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document" style="max-width: 600px;">
                <div class="modal-content">
                    ...
                    <form method="POST" action="/admin-logistic/create-order/{{ $cabang }}/{{ Auth::user()->id }}/submit-order">
                        @csrf
