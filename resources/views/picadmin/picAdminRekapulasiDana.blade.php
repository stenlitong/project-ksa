                            ...
                            <tr>
                                ...
                                <td scope="col">
                                    <div class="row">
                                        ...
                                        {{-- <div class="col-md-auto">
                                            <button class="btn btn-outline-primary" data-toggle="modal" data-target="#Updatespgrnote" data-id="{{ $rekap->id }}">Update</button>
                                            Modal 
                                            <div class="modal fade" id="Updatespgrnote" tabindex="-1" role="dialog" aria-labelledby="Updatespgrnote" aria-hidden="true">
                                                ...
                                                <form action="/picadmin/RekapulasiDana/update/{{$rekap->id}}" id="editForm_{{$rekap->id}}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" id="submitreject2" form="editForm_{{$rekap->id}}" class="btn btn-outline-dark">Add Note</button>
                                                    </div>
                                                </form>
                                            </div>
                                            </div>
