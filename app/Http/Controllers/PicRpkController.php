    ...
    public function uploadrpk(Request $request){
        ...
        if(Auth::user()->cabang == 'Babelan'){ 
            ...
            if ($request->hasFile('rfile1')) {
                ...
                if (documentrpk::where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('cabang' , 'Babelan')->whereColumn('created_at' , '<=', 'periode_akhir')->exists()){
                    
                    documentrpk::where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('cabang' , 'Babelan')->whereColumn('created_at' , '<=', 'periode_akhir')->update([
                        'status1' => 'on review',
        ...
        if(Auth::user()->cabang == 'Berau'){
            ...
            if ($request->hasFile('brfile1')) {
                ...
                if(documentrpk::where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('cabang' , 'Berau')->whereColumn('created_at' , '<=', 'periode_akhir')->exists()){
                    
                    documentrpk::where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('cabang' , 'Berau')->whereColumn('created_at' , '<=', 'periode_akhir')->update([
                        'status1' => 'on review',
                        'surat_barang' => basename($path),
                        'time_upload1' => date("Y-m-d h:i:s"),
                    ]);
        ...
        if(Auth::user()->cabang == 'Banjarmasin'){
            ...
            if ($request->hasFile('bjrfile1')) {
                ...
                if(documentrpk::where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('cabang' , 'Banjarmasin')->whereColumn('created_at' , '<=', 'periode_akhir')->exists()){
                    
                    documentrpk::where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('cabang' , 'Banjarmasin')->whereColumn('created_at' , '<=', 'periode_akhir')->update([
                        'status1' => 'on review',
                        'surat_barang' => basename($path),
                        'time_upload1' => date("Y-m-d h:i:s"),
                    ]);
        ...
        if(Auth::user()->cabang == 'Samarinda'){
            ...
            if ($request->hasFile('smrfile1')) {
                ...
                if(documentrpk::where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('cabang' , 'Samarinda')->whereColumn('created_at' , '<=', 'periode_akhir')->exists()){
                    
                    documentrpk::where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('cabang' , 'Samarinda')->whereColumn('created_at' , '<=', 'periode_akhir')->update([
                        'status1' => 'on review',
                        'surat_barang' => basename($path),
                        'time_upload1' => date("Y-m-d h:i:s"),
                    ]);
        ...
        if(Auth::user()->cabang == 'Jakarta'){
            ...
            if ($request->hasFile('jktfile1')) {
                ...
                if(documentrpk::where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('cabang' , 'Jakarta')->whereColumn('created_at' , '<=', 'periode_akhir')->exists()){
                    Storage::disk('s3')->delete($path."/".$name1);
                    documentrpk::where('nama_kapal', 'Like', '%' . $request->nama_kapal . '%')->where('cabang' , 'Jakarta')->whereColumn('created_at' , '<=', 'periode_akhir')->update([
                        'status1' => 'on review',
                        'surat_barang' => basename($path),
                        'time_upload1' => date("Y-m-d h:i:s"),
                    ]);
