...
class PicsiteController extends Controller
{
    ...
    public function download(){
        $path = Storage::path('berau//stenli-picsite-1.pdf' );
        return Response::download($path, 'stenli-picsite-1.pdf');
    }
    ...
    public function uploadfile(Request $request){
        ...
        if (Auth::user()->cabang == 'Babelan') {
            ...
            if ($request->hasFile('ufile1')) {
                ...
                //$file1->move($tujuan_upload,$name1);
            ...
            if ($request->hasFile('ufile7')) {
                ...
                // $file7->move($tujuan_upload,$name7);
            ...
            if ($request->hasFile('ufile8')) {
                ...
                // $file8->move($tujuan_upload,$name8);
            ...
            if ($request->hasFile('ufile9')) {
                ...
                // $file9->move($tujuan_upload,$name9);
            ...
            if ($request->hasFile('ufile15')) {
                ...
                //$file15->move($tujuan_upload,$name15);
            ...
            if ($request->hasFile('ufile16')) {
                ...
                // $file16->move($tujuan_upload,$name16);
        ...
        if (Auth::user()->cabang == 'Berau') {
            ...
            return redirect('/picsite/upload');
        }
